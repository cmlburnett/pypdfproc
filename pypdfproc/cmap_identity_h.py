"""
Identity-H CMap to convert character codes to unicode.
...
class CMapIdentityH:
	...
	def __init__(self):
		if CMapIdentityH.mapper == None:
			CMapIdentityH.mapper = CMapTokenizer().BuildMapper(CMapIdentityH.cmap_identity_h)

		self.CMapper = CMapIdentityH.mapper
